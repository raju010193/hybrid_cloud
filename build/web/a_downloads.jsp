...
%>
                ...
                <center>
                    <table style="border-style:">
                        <p class="text-center" style="font-weight: bold;">File Download Details Here</p>
                        <hr style="border: 1px solid green;">
                        <tr STYLE="background-color: #999999;font-size: 15px;">                                
                            <td width="150">S.No</td>  <td width="250">FILE NAME</td><td width="250">USER NAME</td><td width="250">DOWNLOADED TIME</td>
                        </tr>
                        <%
                            int count = 0;
                            while (rt.next()) {
