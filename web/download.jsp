    ...
    <body>
        ...
        <div class="row" style="margin-top:10px;">
            <div class="large-8 medium-8 small-4 columns large-centered" style="margin-top: 50px;">
                ...
                <p class="text-center" style="font-weight: bold;">File Download Here</p>
                ...
                <center>
                    <table style="border-style: solid">
                        ...
                        <tr STYLE="background-color: #999999;font-size: 15px;">                                
                            <td width="100px">S.No</td><td width="150px">FILE NAME</td> <td width="150px">OWNER NAME</td><td width="150px">UPLOAD TIME</td><td width="150px">DOWNLOAD</td>
                        </tr>
                        <%
                        int count=0;
                            while (rt.next()) {
                                String id = rt.getString("idfiles");
                                String name1 = rt.getString("filename");
                        ...
                        <TR>
                            ...
                            <td align="center"><a href="download1.jsp?<%=id%>">Download</a></td>
                        </TR>
                        <%}%>
                    </table>
                </center>
