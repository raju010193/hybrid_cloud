...
<style>
    ...
    <body>
       ...
       <div class="row"> 
          <div class="large-8 medium-6 small-4 columns large-centered" style="margin-left: 50px;margin-top: 50px;">
              <form data-abide action="registration" name="ureg" style="position: relative;left: 110px;" method="get" onsubmit="return validation()">
       
       
                    <p class="text-center" style="font-weight: bold;">User Registration Here</p>
                   ...
                   <div class="name-field">
                    ...
                    <div class="name-field">
                     ...
                     <div class="name-field">
                        ...
                        <small class="error">Enter Mail is required.</small>
                    </div>
                     <div class="name-field">
                        <label>Mobile <small>required</small>
                            <input type="number" name="mobile" required>
                        </label>
                        <small class="error">Enter Mobile is required.</small>
                    </div>
                   ...
                   <div class="button-field">
                            ...
                            <div class="row">
                                ...
                                <div class="large-12 columns">
                                    ...
                                    <button type="submit" class="button radius expand" >REGISTER</button>
        ...
        <div class="row footer-section" style="margin-top: 100px">
